...
int main(void)
{
	...
	lcd_show_string(50, 70, 200, 16, 16,	(char*)"Point0 X:");  
	lcd_show_string(50, 100, 200, 16, 16,	(char*)"Point0 Y:");  
	lcd_show_string(50, 130, 200, 16, 16,	(char*)"Point1 X:");  
	lcd_show_string(50, 160, 200, 16, 16,	(char*)"Point1 Y:");  
	lcd_show_string(50, 190, 200, 16, 16,	(char*)"Point2 X:");  
	lcd_show_string(50, 220, 200, 16, 16,	(char*)"Point2 Y:");  
	lcd_show_string(50, 250, 200, 16, 16,	(char*)"Point3 X:");  
	lcd_show_string(50, 280, 200, 16, 16,	(char*)"Point3 Y:");  
	lcd_show_string(50, 310, 200, 16, 16,	(char*)"Point4 X:");  
	lcd_show_string(50, 340, 200, 16, 16,	(char*)"Point4 Y:");  
...
#endif
		lcd_shownum(154, 40, ft5426_dev.point_num , 1, 16);
		lcd_shownum(154, 70, ft5426_dev.x[0], 5, 16);
		lcd_shownum(154, 100, ft5426_dev.y[0], 5, 16);
		lcd_shownum(154, 160, ft5426_dev.x[1], 5, 16);
		lcd_shownum(154, 130, ft5426_dev.y[1], 5, 16);
		lcd_shownum(154, 190, ft5426_dev.x[2], 5, 16);
		lcd_shownum(154, 220, ft5426_dev.y[2], 5, 16);
		lcd_shownum(154, 250, ft5426_dev.x[3], 5, 16);
		lcd_shownum(154, 280, ft5426_dev.y[3], 5, 16);
		lcd_shownum(154, 310, ft5426_dev.x[4], 5, 16);
		lcd_shownum(154, 340, ft5426_dev.y[4], 5, 16);
